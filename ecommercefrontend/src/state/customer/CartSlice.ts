import type {Cart, CartItem} from "../../types/CartTypes.ts";
import {createAsyncThunk, createSlice, type PayloadAction} from "@reduxjs/toolkit";
import {api} from "../../config/Api.ts";
import type {RootState} from "../slice/Store.ts";
import {sumCartItemMrpPrice, sumCartItemSellingPrice} from "../../util/sumCartItemMrpPrice.ts";
