                    ...
                    {searchOpen ? (
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {isCustomer && (
                                    <>
                                        <IconButton onClick={() => navigate("/wishlist")}><FavoriteBorder className="text-blue-700" /></IconButton>
                                        <IconButton component={Link} to="/cart"><AddShoppingCart className="text-blue-700" /></IconButton>
                                        {isSmall && (
